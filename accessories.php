...
.bgimg-1 {
  ...
  background-image: url("homeimg/2.jpg");
  min-height: 100%;
}
...
<div class="w3-container" style="background-color: rgba(230, 227, 227, 0.507);">
    <span class="w3-jumbo w3-hide-small " style=" color: black;">Accessories</span><br>
    <span class="w3-xlarge w3-hide-large w3-hide-medium " style=" color: black;">Accessories</span><br>
...
<div class="w3-container" style="padding:128px 16px" id="team">
    <h1 class="w3-center">Accessories</h1>
...
$getquery="SELECT * FROM accessories";
...
if ($result->num_rows > 0){
  ...
  while($row = $result->fetch_assoc()){
    ...
    <div class='w3-card'>
      ...
      <img src='productImg/".$row['photoN']."' alt='".$row['photoN']."'  style='height: 220px;' >
      ...
      <input type='hidden' name='idd' value='".$row["id"]."'>
        ...
        <p><button onclick='cartAdded();'  type='submit' name='addCarto' class='w3-button w3-light-grey w3-block'><i class='fa fa-shopping-cart'></i> Add to cart</button></p>
        </form>
      </div>
    </div>
  </div> ";
